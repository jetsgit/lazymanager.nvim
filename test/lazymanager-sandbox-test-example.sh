...
# Use the extraction script to patch lazymanager.lua for sandbox
$HOME/Documents/Neovim/LuaProjects/lazymanager.nvim/test/extract-sandbox-lazymanager.sh \
  $HOME/Documents/Neovim/LuaProjects/lazymanager.nvim/lua/lazymanager.lua \
  "$NVIM_CONFIG_DIR/lua/lazymanager.lua"
...
function LazyManager.setup(opts)
  ...
  vim.api.nvim_create_user_command('LazyRestoreTelescope', function()
    LazyManager.telescope_restore()
  end, {})
